...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, nombre: @evento.nombre }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, nombre: @evento.nombre }
    assert_redirected_to evento_path(assigns(:evento))
  end
